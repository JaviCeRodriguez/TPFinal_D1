...
--               z:/Facultad/Digital_1/TPFinal_D1/Voltimetro_JCR/Voltimetro_JCR.srcs/sources_1/ip/clk_generator/clk_generator_sim_netlist.vhdl
...
architecture STRUCTURE of clk_generator_clk_generator_clk_wiz is
  signal clk_i_clk_generator : STD_LOGIC;
  signal clk_o_clk_generator : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_i,
      O => clk_i_clk_generator
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_o_clk_generator,
      O => clk_o
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKIN1 => clk_i_clk_generator,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_o_clk_generator,
